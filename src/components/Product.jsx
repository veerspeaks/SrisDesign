...
function Product({ id, image, title, price, rate, count }) {
  ...
  return (
    <div className="flex flex-wrap justify-center gap-4">
      <div
        key={id}
        className="flex flex-col justify-between max-w-xs w-80 rounded-lg overflow-hidden shadow-lg bg-white m-4 transform transition-transform duration-300 hover:scale-105 hover:shadow-xl"
      >
        ...
        <Link to={`/product/${id}`}>
          ...
          <div className="flex flex-col px-4 py-3 flex-grow items-center justify-between">
        ...
        <div className="px-4 py-2 flex flex-col justify-center gap-2 bg-gray-600 items-center">
